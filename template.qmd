---
title: Mi gran presentación con un título demasiado largo y realmente largo
...
Para una variable aleatoria discreta $X$ con función de probabilidad $P[X = x_i]$ e $i = 1 , 2 , \ldots , n$ la esperanza se define como:
